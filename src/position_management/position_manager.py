...
#         # KEY FIX: Changed the logic to open positions when no opposition exists
#         should_enter = False

#         if direction > 0:  # Long signal
#             # Enter long if we have no net long position or closed opposite positions
#             if net_position <= 0 or len(positions_to_exit) > 0:
#                 should_enter = True
#         else:  # Short signal
#             # Enter short if we have no net short position or closed opposite positions
#             if net_position >= 0 or len(positions_to_exit) > 0:
#                 should_enter = True
